...
async function page({params}: {params: {category: string}}) {
  ...
  return (
    <div className=' flex flex-col bg-transparent  p-2        '>
         ...
         <div className='grid grid-cols-1 p-4 max-w-2xl mx-auto sm:max-w-3xl lg:max-w-5xl hover:bg-pink-100   gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid'>
          {datas.map((p ) => (
            <div key={p._id}  className='flex border-4 transform    hover:shadow-purple-300 rounded-lg p-3  flex-col  transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-95  duration-300 ' >
