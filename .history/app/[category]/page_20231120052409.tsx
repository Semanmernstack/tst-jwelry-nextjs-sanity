...
async function page({params}: {params: {category: string}}) {
    ...
    console.log(datas)
  return (
    <div className=' flex flex-col  bg-purple-700  p-2   transition ease-in delay-150  hover:-translate-y-1 hover:scale-110 duration-300     '>
        ...
        <Link href='/'>
          <p className='flex text-center justify-center'>Back</p>
          </Link>
    </div>
  )
}
