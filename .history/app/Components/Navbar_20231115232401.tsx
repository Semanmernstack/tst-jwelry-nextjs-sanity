  ...
  return (
    <div className='flex flex-col '>
      <div className='flex flex-col '>
          ...
          <div className='flex h-[122px]  items-center animate-accordion-down  justify-between  p-2 sm:p-4   bg-zinc-900  hover:shadow-2xl  '>
              ...
              <Link href={'/'} className='flex  brightness-75  transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-110 duration-300    '>
                 <Image
                  ...
                  width={120}
                  height={80}
                  className=' object-contain rounded-md brightness-75 '
                 />
              </Link>
              <h1 className='italic text-xs sm:text-lg text-white brightness-75  '>Home of luxirous jwelery</h1>
