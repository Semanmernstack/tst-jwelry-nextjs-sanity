  ...
  return (
    <div className='flex flex-col '>
      <div className='flex flex-col '>
          ...
          <div className='flex h-[122px]  items-center animate-accordion-down from-slate-800 via-black to-zinc-900 justify-between sm:justify-around  p-2 sm:p-4   bg-zinc-900  hover:shadow-2xl  '>
