  ...
  return (
    <div className='flex flex-col '>
      <div className='flex flex-col '>
          ...
          <div className='flex h-[130px]  items-center bg-pink-950 animate-accordion-down bg:from-slate-800 bg:via-black bg:to-zinc-900 justify-between sm:justify-around  p-2 sm:p-4     hover:shadow-2xl  '>
