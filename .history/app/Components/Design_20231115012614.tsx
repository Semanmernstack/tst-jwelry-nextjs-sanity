...
function Design() {
  ...
  return (
    <div className='p-4 bg-purple-500 animate-pulse  '>
        <div className='flex gap-2 items-center justify-center '>
            {links.map((l, index) => (
                <div key={index} className='flex rounded-lg w-full md:w-1/2 text-center items-center justify-center  border shadow-md p-2 '>
                    {pathname === l.href ? (
