...
function Footer() {
  return (
    ...
    <div className=' p-8 grid grid-cols-1 cursor-pointer gap-4 sm:grid-cols-2 md:grid-cols-3 bg-zinc-800 text-white brightness-90'>
        <div className='flex flex-col text-center items-center justify-center gap-2 p-3 border shadow-lg decoration:border-xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-95  duration-300'>
            <p>Whatsapp</p>
