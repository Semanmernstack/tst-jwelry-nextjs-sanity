        ...
        <form className="flex flex-col p-3 shadow-2xl" onSubmit={handleSubmit}>
            <div className='gap-2 flex items-center'>
                <input type="email"
                    ...
                    required
                    className="outline-none flex text-white bg-purple-700 h-7 md:h-12  mb-3 p-3 rounded-lg  border-none from-fuchsia-400 "

                 />
                 <button className=" flex cursor-pointer mt-3 text-white bg-zinc-950 p-1 md:p-2  rounded-xl md:rounded-3xl " type='submit' disabled={!input}    >
                    Subscribe
                 </button>
            </div>
