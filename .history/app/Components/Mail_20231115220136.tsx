...
function Mail() {
  ...
  return (
    <div>
        <form className="flex sm:flex-col p-1 shadow-2xl" onSubmit={handleSubmit}>
            <div>
                <input type="email"
                    ...
                    required
                    className="outline-none text-white bg-purple-700 h-7 md:h-12  mb-3 p-3 rounded-lg mr-10 border-none from-fuchsia-400 "
