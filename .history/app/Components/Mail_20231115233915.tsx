        ...
        <form className="flex flex-col p-3 shadow-2xl" onSubmit={handleSubmit}>
            <div className='gap-2 flex flex-col md:flex-row items-center'>
                <input type="email"
                    ...
                    required
                    className="outline-none  flex-1 text-white bg-purple-700 h-7 md:h-12   p-3 rounded-lg  border-none from-fuchsia-400 "

                 />
                 <button className=" flex cursor-pointer  text-white bg-zinc-950 p-2 text-xs sm:text-lg rounded-xl md:rounded-3xl " type='submit' disabled={!input}    >
                    Subscribe
                 </button>
            </div>
