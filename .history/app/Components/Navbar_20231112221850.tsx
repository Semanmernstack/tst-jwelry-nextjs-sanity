...
function Navbar() {
  return (
    <div className='flex flex-col '>
        <h1 className='item-center text-center justify-center text-sm shadow-lg p-2 w-full bg-green-500'>Free delivery for over 100,000 product</h1>
        <div className='flex  items-center animate-accordion-down  justify-between p-4 shadow-inner bg-purple-400   rounded-md   hover:bg-purple-600  h-24'>
