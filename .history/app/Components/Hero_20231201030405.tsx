  ...
  return (
    ...
    <div> 
        ...
        <Carousel {...settings}>
                ...
                <div>
                    <Image className='w-full object-cover fill  h-[60%] fill' src="/slide-five.png" alt='picfoo' />
                    
                </div>
                <div>
                    <Image className='full object-cover  h-[60%] fill' src="/slide-two.png" alt='picfiv' />
