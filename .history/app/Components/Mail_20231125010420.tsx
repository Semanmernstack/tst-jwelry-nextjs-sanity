        ...
        <form className="flex  flex-col p-3 " onSubmit={handleSubmit}>
            <div className='gap-2 flex w-full flex-col md:flex-row items-center'>
                <input type="email"
                 ...
                 />
                 <button className="text-xs text-center justify-center flex cursor-pointer h-9   text-white bg-zinc-950 p-2  sm:text-lg transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-95  duration-300  rounded-xl md:rounded-2xl " type='submit' disabled={!input}    >
                    Subscribe
                 </button>
            </div>
