    ...
    <div>
        <form className="flex flex-col p-3 shadow-2xl" onSubmit={handleSubmit}>
            <div className='gap-2 flex items-center'>
                <input type="email"
                 ...
                 />
                 <button className=" flex cursor-pointer  text-white bg-zinc-950 p-3  rounded-xl md:rounded-3xl " type='submit' disabled={!input}    >
                    Subscribe
                 </button>
            </div>
        ...
        {(mailOk || mailError ) && ( 
            <div className="mt-5 text-sm text-center justify-center font-extrabold">
             {mailOk ?(<p className=" bg-red-900 p-1"> Subsription Sucessful !! </p>):(<p className="bg-green-500 p-1">You already Subscribed</p>)}
            </div>
        )}    
