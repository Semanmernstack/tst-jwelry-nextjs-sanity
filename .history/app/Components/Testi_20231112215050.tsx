...
async function Testi() {
  ...
  return (
    <div className='max-w-2xl gap-3 mx-auto sm:max-w-3xl     p-5'>
        <h1 className='text-center  p-2 rounded-md text-blue-500 font-sans justify-cente font-extrabold text-xl md:text-2xl'>Our Client </h1>
        <div className=' p-2  grid grid-cols-1 gap-3   sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4   '>
            {datas.map((t: any) => (
                <div  className=' borde-2 flex bg-slate-500 hover:bg-purple-600 flex-col shadow-md gap-2 p-2 rounded-md  ' key={t._id}>
