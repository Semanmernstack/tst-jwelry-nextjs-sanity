        ...
        <form className="flex  flex-col p-3 " onSubmit={handleSubmit}>
            <div className='gap-2 flex w-full  items-center'>
                <input type="email"
                    ...
                    required
                    className="outline-none flex flex-0.8 w-full text-white bg-purple-700 h-7 md:h-12   p-1 rounded-lg  border-none from-fuchsia-400 "

                 />
                 <button className=" flex cursor-pointer flex-0.2  text-white bg-zinc-950 p-1 text-xs sm:text-lg rounded-xl md:rounded-3xl " type='submit' disabled={!input}    >
                    Subscribe
                 </button>
            </div>
