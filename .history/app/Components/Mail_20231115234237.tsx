...
function Mail() {
  ...
  return (
    <div className='flex flex-col items-center  '>
        <form className="flex w-full flex-col p-3 " onSubmit={handleSubmit}>
            <div className='gap-2 flex w-full flex-col md:flex-row items-center'>
                <input type="email"
                    ...
                    required
                    className="outline-none flex flex-1 w-full text-white bg-purple-700 h-7 md:h-12   p-1 rounded-lg  border-none from-fuchsia-400 "
