...
async function Product() {
  ...
  return (
    <div>
         <div className='grid grid-cols-1 shadow-md     gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid'>
          {datas.map((p ) => (
            <div className='flex border-4 transform  duration-75  hover:ease-out  hover:bg-purple-200 rounded-lg p-3  flex-col' key={p._id}>
