    ...
    <div className='flex flex-col '>
      <div className='flex flex-col '>
          ...
          <div className='flex h-[100px] sm:[130px]  items-center bg-purple-950 animate-accordion-down bg:from-slate-800 bg:via-black bg:to-zinc-900 justify-between  p-2 sm:p-4     hover:shadow-2xl  '>
              ...
              <Link href={'/'} className='flex  brightness-75  transition ease-in delay-150  hover:-translate-y-1 hover:scale-110 duration-300    '>
                 <Image
                  src='/tstlogo.jpg'
                  alt='logoo'
                  width={100}
              ...
              <div className='flex flex-col items-center'>
                <div>
                  <h1 className='italic text-xs sm:text-xl md:text-2xl  text-white brightness-15  '>Home of luxurious jwelery</h1>
                </div>

                <div className='flex gap-2 text-xs md:text-lg brightness-150 text-gray-500  font-semibold items-center'>
                  <p>Owanbe |</p>
                  <p>Coperate |</p>
                  <p>Classic</p>
                </div>
