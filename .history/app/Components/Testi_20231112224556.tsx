  ...
  return (
    <div className='max-w-2xl gap-3 mx-auto sm:max-w-3xl md:max-w-4xl lg:max-w-5xl     p-5'>
        ...
        <div className=' p-2  grid grid-cols-1 gap-3   sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4   '>
            {datas.map((t: any) => (
                <div  className=' borde-2 flex bg-slate-500 hover:bg-purple-600 flex-col shadow-lg gap-3 p-2 rounded-md transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110  duration-300  ' key={t._id}>
