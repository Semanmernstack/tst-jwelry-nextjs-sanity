...
function Navbar() {
  return (
    <div className='flex flex-col '>
      ...
      <div className='flex flex-col '>
          <h1 className='item-center   text-center text-white justify-center text-sm shadow-lg p-2 w-full bg-green-500'>Free delivery for over N100,000 products</h1>
          <div className='flex h-[100px] sm:[130px]  items-center bg-purple-950 animate-accordion-down bg:from-slate-800 bg:via-black bg:to-zinc-900 justify-between  p-2 sm:p-4     hover:shadow-2xl  '>
              ...
              <div className='flex flex-col items-center'>
                <div>
                  <h1 className='italic text-sm font-extrabold sm:text-xl md:text-2xl  text-white brightness-15  '>Home of luxurious jewelry</h1>
                </div>
