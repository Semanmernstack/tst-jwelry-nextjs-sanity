        ...
        <form className="flex  flex-col p-3 " onSubmit={handleSubmit}>
            <div className='gap-2 flex w-full flex-col md:flex-row items-center'>
                <input type="email"
                    ...
                    required
                    className="outline-none flex-1 w-[200px] sm:w-[300px] md:w-[400px]  lg:w-[800px] text-white bg-red-700 border-2 h-8 md:h-8   p-2 rounded-lg  border-none from-fuchsia-400 "
